...
var Phone=[
{
    ...
    ram:'8 GB',
    memory:'256 GB',
    image:'assets/img/namePhone/Samsung/samsung-galaxy-z-flip4-flex-mode-dd-docquyen-bh.webp',
},
{
    type:'Samsung',
...
},
{
    ...
    ram:'3 GB',
    memory:'32 GB',
    image:'assets/img/namePhone/Vivo/637707822857432352_00779950-vivo-y15s-trang-xanh-dd.webp',
},
{
    type:'Vivo',
...
},
{
    ...
    ram:'8 GB',
    memory:'128 GB',
    image:'assets/img/namePhone/Vivo/637983398315589960_vivo-y22s-xanh-dd.webp',
},
{
  type:'Nokia',
...
for(var i=0;i<Phone.length/2;i++)
{
  ...
  item.classList.add('Samsung');
  if(Phone[i].type=='Iphone') 
  item.classList.add('Iphone');
  if(Phone[i].type=='Xiaomi') 
  item.classList.add('Xiaomi');
  if(Phone[i].type=='Nokia') 
  item.classList.add('Nokia');
  if(Phone[i].type=='Oppo') 
  item.classList.add('Oppo');
  if(Phone[i].type=='Vivo') 
  item.classList.add('Vivo');
